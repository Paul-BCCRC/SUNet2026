...
from UNET_Structures import UNet_A, accuracy
...
in_data = r'G:\DATA\UNET_A_Trainingsets\Test'
outpath = r'G:\DATA\UNET_A_Trainingsets\Test'

initial_weights = r'G:\DATA\UNET_A_Trainingsets\UNET_A.pth'
save_weights = outpath + r'\UNET_A.pth'
...
model = UNet_A(Nfeatures).to(device)
if(isSGD):
